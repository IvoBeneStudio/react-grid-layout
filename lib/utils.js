...
export function compactItem(
  ...
  while ((collides = getFirstCollision(compareWith, l))) {
    ...
    if ((compactH || compactHList) && l.x + l.w > cols) {
      l.x = cols - l.w;
      l.y++;
    }
  }
...
export function moveElementAwayFromCollision(
  ...
  if (isUserAction) {
    ...
    const fakeItem: LayoutItem = {
      x:
        compactH || compactHList
          ? Math.max(collidesWith.x - itemToMove.w, 0)
          : itemToMove.x,
      y:
        compactV || compactHList
    ...
    if (!getFirstCollision(layout, fakeItem)) {
      ...
      return moveElement(
        ...
        compactV || compactHList ? fakeItem.y : undefined,
        isUserAction,
        preventCollision,
        compactType,
        cols
  ...
  return moveElement(
    ...
    compactV || compactHList ? itemToMove.y + 1 : undefined,
    isUserAction,
    preventCollision,
    compactType,
    cols
...
export function sortLayoutItems(
  ...
  else if (compactType === "horizontalList")
